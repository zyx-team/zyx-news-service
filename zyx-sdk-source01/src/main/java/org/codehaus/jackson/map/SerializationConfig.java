    ...
    extends MapperConfig.Impl<SerializationConfig.Feature, SerializationConfig>
{
    ...
    public enum Feature implements MapperConfig.ConfigFeature
    {
         ...
         * for POJO fields (note: does <b>not</b> apply to {@link Map}
         * serialization!):
        ...
        /**
         * Feature that determines whether {@link Date} values
         ...
         *<p>
         * Note: whether {@link Map} keys are serialized as Strings
         * or not is controlled using {@link #WRITE_DATE_KEYS_AS_TIMESTAMPS}.
         */
        WRITE_DATES_AS_TIMESTAMPS(true),

        /**
         * Feature that determines whether {@link Date}s
         * (and sub-types) used as {@link Map} keys are serialized
